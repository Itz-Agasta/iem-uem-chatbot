  ...
  return (
    <div className="kiosk-header">
      ...
      <div className="header-right-group">
        <a href="/admin" className="admin-access-btn" title="Admin portal" aria-label="Open admin portal">
        ...
        <img src="/branding/uem_logo.svg" alt="University of Engineering & Management" className="brand-logo brand-logo-right" />
      </div>
    </div>
  );
}
